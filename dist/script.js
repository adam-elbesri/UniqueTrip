const cntr_loc = L.latLng(46.227638, 2.213749);
const orig_loc = L.latLng(48.856614, 2.3522219);
const dest_loc = L.latLng(45.439695, 4.3871779);
const dest2_loc = L.latLng(45.764043, 4.835659);
const dest3_loc = L.latLng(45.7833, 3.0833);
...
function begin_routing(hlat, hlong, dep1 , dep2, lat1, long1, lat2, long2, lat3, long3) {
  L.Routing.control({
    waypoints: [
       L.latLng(hlat, hlong),
       L.latLng(lat1, long1),
